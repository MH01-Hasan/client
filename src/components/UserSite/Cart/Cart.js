...
import { crealecart, decreasecart, getTotals, increasetocart, removeFromCart } from '../../../Redux/cardSlics';
                ...
                cart.cardItem.length === 0 ? (
                    ...
                    <div className='container'>
                        <Table responsive className='cart-product-fild'>
                            ...
                            <tbody>
                                {
                                    cart?.cardItem?.map(cartItem => <tr key={cartItem._id} className="tr-fild" >
                                        ...
                                        <td className='fild-image'> <div className="child2 ">
