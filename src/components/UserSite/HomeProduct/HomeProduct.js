    ...
    <div className="mb-5 mx-5">
      ...
      <div className="row mt-5">
        ...
        <div className="col-lg-5 col-sm-12 mt-5 thard-contaent-secend-part">
          <h1>MNVN ORANGE</h1>
          <p>
            The Yeezy 700 V3 debuted in 2019 as an evolutionary version of the
            original Yeezy Boost 700. Redesigned style elements include the
            removal of Boost cushioning in the midsole in favor of lightweight
            EVA foam and an added RPU cage for stability. The shoe’s blue
            “Azareth” Primeknit upper is contrasted by sections of white and
            dark green fabric. A futuristic glow-in-the-dark treatment is
            applied to the translucent overlay cage. Release date: August 29,
            2020.
          </p>
        </div>
      </div>
          ...
          <div className="walate col-lg-12 col-sm-12">
            <div className="row others-part-one">
              ...
              <div className="secend-image">
                <Link to="/product/catagory/Watch">
          ...
          <div className="third-dection">
            <div className="row others-part-one">
              <div className="third-first-image ">
                <Link to="/product/catagory/Wallet">
                  <div>
              ...
              <div className="third-secend-image">
                <Link to="/product/catagory/Others">
                  <div className="contaner">
                    <img src={Others} alt="" />
                  </div>
                </Link>
